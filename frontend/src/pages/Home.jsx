            ...
            <section style={{ padding: '1rem 0', overflow: 'hidden', position: 'relative' }}>
                <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
                    ...
                    <div style={{ position: 'relative', height: '500px' }} className="animate-fade-in">
                        ...
                        <div className="glass-panel animate-float" style={{
                            position: 'absolute', bottom: '15%', left: '-20px',
                            padding: '1rem', borderRadius: '16px',
                            display: 'flex', alignItems: 'center', gap: '1rem',
                            animationDelay: '2s',
                            boxShadow: '0 10px 30px rgba(0,0,0,0.3)',
                ...
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                        {mentors.length > 0 ? mentors.map((mentor) => (
                            <div key={mentor.id} className="glass-panel card-3d-hover" style={{ padding: '2rem', textAlign: 'center' }}>
                                <div style={{
                                    ...
                                    overflow: 'hidden', border: '3px solid var(--bg-card)', boxShadow: '0 5px 15px rgba(0,0,0,0.2)'
                                }}>
                                    {mentor.image ? (
                ...
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        {[
                            ...
                            <div key={i} className="glass-panel card-3d-hover" style={{ padding: '2.5rem', textAlign: 'center', transitionDelay: `${i * 100}ms` }}>
                        ...
                        {[
                            ...
                            <div key={i} className="glass-panel" style={{ padding: '2rem' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <img src={review.image} alt={review.name} style={{ width: '40px', height: '40px', borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--border-color)' }} />
                                    <div>
